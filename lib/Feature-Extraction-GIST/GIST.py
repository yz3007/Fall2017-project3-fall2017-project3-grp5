...
# Set pathes and read all jpg files name
path = "/Users/siyi/Documents/Study-Columbia/17FALL/GR5243-Applied-Data-Science/Project3/training_set/images"
...
for index, jpg_pic in enumerate(jpg_files):
    feature = feature_extract(jpg_pic)
    # Record time
    # if index % 50 == 0:
    #     print(index)
